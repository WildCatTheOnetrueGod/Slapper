...
(function () {
  ...
  overlayCanvas.addEventListener('mouseleave', () => renderOverlay());
  ...
  (function makeDraggable() {
    ...
    filterPanelHeader.addEventListener('mousedown', (e) => {
  ...
  function openOpacityPopup(layer, anchor) {
    ...
    const remove = (e) => { if (!popup.contains(e.target) && e.target !== anchor) { popup.remove(); document.removeEventListener('mousedown', remove); } };
